...
birds_wrangled <- birds_clean |>
  ...
  # filter to include:
    # observations between Oct 1, 2021 and Sept 30, 2025 (4 water years)
  filter(observation_date > "2021-09-30" & observation_date < "2025-10-01",
         ...
         # Mallard, Black-crowned Night-Heron, Killdeer, Song Sparrow
         species %in% c("Mallard",
                        "Black-crowned Night-Heron",
                        "Killdeer",
                        "Song Sparrow")) |>
  # creates a new column `water_year` which assigns each observation to:
  # wy2022, wy2023, wy2024, or wy2025 based on year of the observation date
  ...
  # groups observations by species & water year 
  group_by(species, water_year) |>
  # sums total observations for each species in each water year
